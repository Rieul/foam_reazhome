...
## “[Open-Source won. So, now what ?](http://www.wired.com/2016/08/open-source-won-now/)”

Shared experiences, thoughts and discussions, as well as meet-ups with a wide diversity of people and recent questionning about wether or not being affiliated by brand, led me to this thought : “**How is it possible, in an age of massively surrounding available information, that we stick at claiming paternity of if and enclosing it ?**”.

As [Klint Finley](http://www.wired.com/author/kfinley/) puts it in its [Wired](http://www.wired.com/) article : “[Open Source Won. So, Now What ?](http://www.wired.com/2016/08/open-source-won-now/)”. Well... now might be the good time to move towards the Commons. It thus appears that a necessary prerequisite is the autonomy of the Information-Space. But “**Can we afford such thing as autonomy of the Information-Space ?**”

## Civilization of the Commons is also about Autonomy of the Information-Space
...
To organisations, companies and governments, to the people and entities who think that information is owned based and belongs to the framework that makes it possible to emerge and grow;

To those who consciously or unconsciously fight for claiming for any kind of structure attachment, appropriation and spoliation;
...
Sovereignty cannot be about power, domination, omnipotence and supremacy anymore but about Power, emancipation, autonomy and resilience.
...
We do clame our affiliation and kinship to part or all of your principles and values, as well as your philosophy and ways of thinking, making, doing and acting — amongst other ones. However, while we might agree on values, our practices  ma not be compatible.

As a few, we do embed in our DNA the hacking principle and hacker ethic… and so do we trust the fork principle.

The Information-Space is about the autonomy of the information: one of the most massive hack of the way society has been teaching us to behave for more than five centuries.

We are creating a civilization of the Commons.

![](assets/img/info-space-autonomy-1.jpeg)

_**Note**: as introduced along this article, _“_[_A Declaration of the Independence of the Cyberspace_](https://www.eff.org/fr/cyberspace-independence)_”_ from [John Perry Barlow](https://fr.wikipedia.org/wiki/John_Perry_Barlow) has come to inspire this attempt for an open-to-contribution declaration of autonomy of Information-Space._

> * About the distinction between "power" and "Power", see [Alain DAMASIO « La zone du Dehors »](https://fr.wikipedia.org/wiki/La_Zone_du_dehors)
